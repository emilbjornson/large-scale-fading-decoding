function SINRLSFDCorrelatedSMMSE_Appr = Func_LSFD_CorrelatedSMMSE_Appr(lossovernoise, EstError, InveseEstPhi, CorrelatedFading, DataPowerMatix, PilotPowerMatrix,nbrBSs,K,tau, NBScases)
...
SINRLSFDCorrelatedSMMSE_Appr = zeros(nbrBSs,K);% Space for SINRvalues;
...
for l = 1 : nbrBSs
    for k = 1:K
        ...
        SINRLSFDCorrelatedSMMSE_Appr(l,k) = Numerator_Appr/Denumerator_Appr;
